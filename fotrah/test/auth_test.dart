...
void main() {
  group("Mocl Authentication", () {
    ...
    test("Should be able to initialize in less htan 2 seconds", () async {
      await provider.initialize();
      expect(provider.isInitialized, true);
...
class MockAuthProvider implements AuthProvider {
  ...
  Future<AuthUser> logIn({required String email, required String password}) {
    if (!isInitialized) throw NotInitializedException();
    if (email == 'apeto209@gmail.com') throw UserNotFoundAuthException();
    if (password == '123123') throw WrongPasswordAuthException();
    const user = AuthUser(isEmailVerified: false, email: 'asda@gmail.com', id: 'myid');
    _user = user;
  ...
  Future<void> sendEmailVerificaiton() async {
    ...
    const newUser = AuthUser(isEmailVerified: true, email: 'asda@gmail.com', id: 'myid');
    _user = newUser;
  }
}
